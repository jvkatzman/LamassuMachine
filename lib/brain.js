...
Brain.prototype._pollUpdate = function _pollUpdate () {
  ...
  if (this._needsIdleRefresh() || cartridgeWasReset) this._idle()
}
...
Brain.prototype._billRejected = function _billRejected () {
  ...
  this._screenTimeout(function () { self._sendBitcoins() }, 30000)
...
Brain.prototype._doSendBitcoins = function _doSendBitcoins () {
  ...
  this._setState('bitcoinsSent')
  this._executeSendBitcoins()
}

Brain.prototype._executeSendBitcoins = function _executeSendBitcoins () {
  this.getBillValidator().disable()
